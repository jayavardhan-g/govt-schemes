...
class RuleParser:
    def __init__(self):
        self.INDIAN_JOBS = [
            "farmer", "engineer", "welder", "doctor", "nurse",
            "home maker","teacher", "professor", "student",  "shopkeeper",
            "manager", "police", "soldier", "army", "lawyer","government employee",
            "civil servant",  "fisherman", "driver", "chef",
            "electrician", "plumber", "artisan","carpenter", "accountant", "banker",
            "business owner", "entrepreneur","software developer",  "security guard",
            "architect", "journalist", "photographer", "labourer", "advocate",
            "researcher", "scientist", "delivery agent", "rickshaw puller",
            "tailor", "mechanic",  "data entry operator", "clerk",
             "housewife", "unemployed", "retired","cleaner",
        ]
