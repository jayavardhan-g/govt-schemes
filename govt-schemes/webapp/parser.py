...
h_keywords = [
    "conditions for eligibility", "who can apply", "who is eligible","eligible", "applicants",
    "eligibility", "eligibility criteria" 
]

fb_words = [
    "citizen", "widow", "women", "income", "annual income", "age", "years", "resident","household", "beneficiary", "ownership", "landholding", "student",
